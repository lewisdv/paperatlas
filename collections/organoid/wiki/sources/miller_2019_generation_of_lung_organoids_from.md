...
raw_source: raw/sources/miller_2019_generation_of_lung_organoids_from.pdf
article_url: https://www.nature.com/articles/s41596-018-0104-8
published_date: 2019-01-21
organ: lung
protocol_focus: foundational lung organoid generation from hPSCs
...
- PDF: [raw/sources/miller_2019_generation_of_lung_organoids_from.pdf](../../raw/sources/miller_2019_generation_of_lung_organoids_from.pdf)
- Article: [https://www.nature.com/articles/s41596-018-0104-8](https://www.nature.com/articles/s41596-018-0104-8)
- Status: deep ingested on 2026-04-08
- Organ focus: lung
- Protocol focus: foundational lung organoid generation from hPSCs

## Study design

- Starting material: human pluripotent stem cells
- Protocol type: stepwise derivation and maturation protocol
- Aim: foundational lung organoid generation from hPSCs
- Core readouts: organoid morphology, lineage markers, and downstream functional assays

## Summary

- This paper is best understood as a stepwise derivation and maturation protocol for foundational lung organoid generation from hPSCs.
- Its main distinctive contribution in this corpus is that it offers a baseline pluripotent-stem-cell route into lung organoid generation.
- Within this collection, it belongs to the baseline derivation branch of organoid protocol work.
- Paper framing: describe a protocol that recapitulates several of these milestones in order to differentiate human pluripotent stem cells (hPSCs) into ventral-anterior foregut spheroids and further into two distinct types of organoids: human lung organoids and bud tip progenitor organoids.

## Key findings

- Defines a workflow centered on foundational lung organoid generation from hPSCs.
- Its distinctive focus in practice is the way it offers a baseline pluripotent-stem-cell route into lung organoid generation.
...
- Specific role in this corpus: Serves as the foundational respiratory protocol before later disease-specific lung refinements.
...
- [Distal lung organoids](../entities/distal-lung-organoids.md)
