...
- Organ focus: brain
- Protocol focus: brain assembloids to interrogate human neural circuits

## Study design

- Starting material: human pluripotent stem cells
- Protocol type: multi-lineage developmental organoid protocol
- Aim: brain assembloids to interrogate human neural circuits
- Core readouts: organoid morphology, lineage markers, and downstream functional assays

## Summary

- This paper is best understood as a multi-lineage developmental organoid protocol for brain assembloids to interrogate human neural circuits.
- Its main distinctive contribution in this corpus is that it establishes a workflow for brain assembloids to interrogate human neural circuits.
...
- Defines a workflow centered on brain assembloids to interrogate human neural circuits.
- Its distinctive focus in practice is the way it establishes a workflow for brain assembloids to interrogate human neural circuits.
...
- Specific role in this corpus: Extends the corpus with brain work and strengthens the multi-lineage organoid coverage around brain assembloids to interrogate human neural circuits.
