...
- A follow-up consolidation pass now wires the most relevant developmental concept and query pages back to that synthesis, so developmental route choice can start from the synthesis layer and only drop into old queries for detail.
