...
### Brain organoid benchmarking and cross-protocol atlases (Rounds 2-3)

- Velasco 2019 — dorsally patterned reproducibility (Nature)
- Yoon 2019 — cortical spheroid reliability (Nat Methods, Pasca lab)
- Bhaduri 2020 — cell stress and fidelity counterpoint (Nature, Kriegstein lab)
- Kanton 2019 — temporal + cross-species scRNA-seq atlas (Nature)
- He 2024 — integrated cross-protocol cell atlas, 26 protocols, 1.7M cells (Nature)

### Organ+vascular intersections (Round 4)

- Wimmer 2019 — standalone blood vessel organoid (Nat Protoc)
- Cakir 2019 — ETV2-driven vascularized brain organoid (Nat Methods)
- Homan 2019 — flow-enhanced kidney vascularization on chip (Nat Methods)
- Wörsdorfer 2019 — MPC-incorporated multi-lineage vascular organoids (Sci Rep)

### New organ systems (Rounds 2-3)

- Pereira 2021 — sensorimotor organoid with NMJs (spinal cord/neuromuscular, Nat Comms)
- Kuwahara 2015 — retinal organoid with ciliary margin niche (Sasai lab, Nat Comms)
- Koehler 2017 — inner ear organoid with functional hair cells (Nat Biotech)
- van der Valk 2025 — vestibular inner ear organoid protocol (Nat Protoc)
- Hogrebe 2021 — planar SC-β cell differentiation (Nat Protoc)
- Balboa 2022 — SC-islet functional maturation benchmarking (Nat Biotech)
