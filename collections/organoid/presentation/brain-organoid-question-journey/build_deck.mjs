...
const SLIDES = [
  ...
  {
    "kicker": "SECTION 02",
    "title": "Replace slide 2 title",
    "subtitle": "Replace with the main claim this slide must support.",
    "expectedVisual": "Slide 2 with editable cards or diagram elements and a visible text-free art-direction background.",
    "cards": [
      [
        "Replace",
        "Add a specific, sourced point for this slide."
      ],
      [
        "Author",
        "Create charts with native slide.charts.add(...); use editable geometry for cards, steps, and callouts."
      ],
      [
        "Verify",
        "Render the preview, inspect it at readable size, and fix actionable layout issues within 3 total render loops."
      ]
    ],
  ...
  {
    "kicker": "SECTION 06",
    "title": "Replace slide 6 title",
    "subtitle": "Replace with the main claim this slide must support.",
    "expectedVisual": "Slide 6 with editable metric cards and a visible text-free art-direction background.",
    "metrics": [
      [
        "00",
        "Replace metric label",
  ...
  {
    "kicker": "SECTION 07",
    "title": "Replace slide 7 title",
    "subtitle": "Replace with the main claim this slide must support.",
    "expectedVisual": "Slide 7 with editable cards or diagram elements and a visible text-free art-direction background.",
    "cards": [
      [
        "Replace",
        "Add a specific, sourced point for this slide."
  ...
  {
    "kicker": "SECTION 08",
    "title": "Replace slide 8 title",
    "subtitle": "Replace with the main claim this slide must support.",
    "expectedVisual": "Slide 8 with editable cards or diagram elements and a visible text-free art-direction background.",
    "cards": [
      [
        "Replace",
        "Add a specific, sourced point for this slide."
  ...
  {
    "kicker": "SECTION 09",
    "title": "Replace slide 9 title",
    "subtitle": "Replace with the main claim this slide must support.",
    "expectedVisual": "Slide 9 with editable metric cards and a visible text-free art-direction background.",
    "metrics": [
      [
        "00",
        "Replace metric label",
