...
- Current anchor systems: [SAVE](entities/SAVE.md), [SCimilarity](entities/SCimilarity.md), [C2S-Scale](entities/C2S-Scale.md), and [AURORA](entities/AURORA.md).
...
- Four source pages have been deeply ingested so far.
