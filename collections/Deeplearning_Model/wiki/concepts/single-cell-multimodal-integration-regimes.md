...
- [scMVP](../entities/scMVP.md) is a vertical-integration model specialized to same-cell RNA and ATAC measurements.
- [totalVI](../entities/totalVI.md) models paired CITE-seq RNA and proteins while also integrating datasets with different protein panels or RNA-only blocks.
