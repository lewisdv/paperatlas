...
- [ARTEMIS](../entities/ARTEMIS.md) supplies another continuous-state alternative: its unbalanced Schrödinger bridge fits stochastic paths between observed time-series marginals rather than a DDIM denoising process.
